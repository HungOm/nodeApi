...
workers.validateCheckData = function (originalCheckData) {
    ...
    originalCheckData.userPhone = typeof (originalCheckData.userPhone) == 'string' && originalCheckData.userPhone.trim().length >= 10 && originalCheckData.userPhone.trim().length<=12 ? originalCheckData.userPhone.trim() : false;
