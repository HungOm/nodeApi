...
helpers.sendTwillioSMS('0178868331','Hello ',function(err){
...
handlers._users.post = function (data, callback) {
  ...
  var tosAgreement =
    ...
    console.log(typeof data.payload.password == "string"  +" iiuiuiuiuiui")
    console.log(phone+" iiuiuiuiuiui")
    console.log(tosAgreement+" iiuiuiuiuiui")
                      ...
                      if(err){
                        ...
                        if(checksDeleted ==checksToDelete){
                          if(!deletionError){
                            ...
                            callback(500,{"Errors":"Error encountered attempting to delete all of the user\s checks. All checks may not have been deleted from the system successfully"})
                          }
                        }
                      }
                    })
  ...
  if (id) {
    ...
    _data.read('checks',id,function(err,checkData){
      ...
      handlers._tokens.varifyToken(token,checkData.userPhone, function(tokenIsValid) {
        ...
        callback(400,{"Error":"Thie specified checkID does not exist"})
      }
    });
